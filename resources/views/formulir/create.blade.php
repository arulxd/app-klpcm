<x-app-layout>
    <div class="mb-6 flex items-center justify-between">
        <h2 class="text-2xl font-bold text-black">Tambah Formulir Baru</h2>
    ...
    <div class="rounded-xl border border-gray-200 bg-white shadow-sm p-8 max-w-2xl">
        <form action="{{ route('formulir.store') }}" method="POST">
            ...
            <div class="mb-6">
                ...
                <input type="text" name="nama" placeholder="Contoh: Resume Medis / Laporan Operasi" required autofocus
                ...
                <p class="mt-2 text-xs text-gray-500">Nama formulir ini akan muncul di dropdown saat input analisis ketidaklengkapan.</p>
            </div>
            ...
            <div class="mb-6">
                ...
                <div class="relative">
                    <select name="kategori" required class="w-full appearance-none rounded-lg border border-gray-300 bg-white px-4 py-3 pr-8 text-sm focus:border-indigo-500 focus:ring-2 focus:ring-indigo-100 outline-none transition">
                        ...
                        <option value="manual">Manual (Kertas)</option>
                        <option value="elektronik">Elektronik (E-RME)</option>
                    </select>
            ...
            <div class="flex items-center justify-end gap-4 border-t border-gray-100 pt-6">
                ...
                <button type="submit" class="rounded-lg bg-indigo-600 px-6 py-2.5 text-sm font-bold text-white hover:bg-indigo-700 transition shadow-md hover:shadow-lg">Simpan Data</button>
            </div>
        </form>
    </div>
</x-app-layout>